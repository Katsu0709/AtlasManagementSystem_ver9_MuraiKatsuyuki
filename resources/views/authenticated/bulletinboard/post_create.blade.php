    ...
    <div class="post_create_area border w-50 m-5 p-5">
      <div class="">
        ...
        <select class="w-100 rounded" name="sub_category_id" form="postCreate">
          ...
          <option value="" disabled style="color: gray; font-weight:bold;">
      ...
      <div class="mt-3">
        ...
        <span class="error_message h6" style="color: red;">{{ $errors->first('post_title') }}</span>
        @endif
        <p class="mb-0">タイトル</p>
      ...
      <div class="mt-3">
        ...
        <span class="error_message h6" style="color: red;">{{ $errors->first('post_body') }}</span>
        @endif
        <p class="mb-0">投稿内容</p>
    ...
    <div class="w-25 ml-auto mr-auto">
      <div class="category_area mt-5 p-5">
        ...
        <div class="m-4">
          ...
          <span class="error_message h6" style="color: red;">{{ $errors->first('main_category_id') }}</span>
          @endif
